...
define('BD', 'wquentel_festival');       // nom de la base de données
define('LOGIN', 'wquentel_festiva');    // login d'un utilisateur de MySql avec des droits sur la BDD
define('MDP', 'Uraret98');        // mot de passe de cet utilisateur
